    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pipeline', models.ForeignKey(related_name='programs', to='pipeline.Pipeline', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pipeline', models.ForeignKey(related_name='runs', to='pipeline.Pipeline', on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('piperun', models.ForeignKey(related_name='programs', to='pipeline.PipelineRun', on_delete=models.CASCADE)),
                ('program', models.ForeignKey(related_name='runs', to='pipeline.Program', on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='program',
            field=models.ForeignKey(related_name='pipelines', to='pipeline.Program', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='pipeline',
            name='test_files',
